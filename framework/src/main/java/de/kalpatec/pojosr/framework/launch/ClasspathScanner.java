...
public class ClasspathScanner
{
	...
	protected Map<String, String> getManifestHeaders(URL manifestURL) throws IOException, UnsupportedEncodingException, Exception 
	{
    ...
    protected URL getParentURL(URL url) throws Exception
    {
